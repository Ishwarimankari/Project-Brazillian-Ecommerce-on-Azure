...
storage_account = "olistdatastoragebyme"
application_id = "8a1b3520-71ab-483d-a77a-8769f69f4a1c"
directory_id = "ebce661c-c470-47ef-a8aa-485a27ba3c75"
client_secret = "ag58Q~Ut3iaKLD0DYWimYUc8YcdfzFW2XwfxQc4K"   # ✅ MUST be here
...
df = spark.read.format("csv").option("header", "true").load(f"abfss://olistdata@olistdatastoragebyme.dfs.core.windows.net/bronze/olist_customers_dataset.csv")

display(df)

# COMMAND ----------

base_path = "abfss://olistdata@olistdatastoragebyme.dfs.core.windows.net/bronze/"
...
hostname = "139mdh.h.filess.io"
database = "olistDataNoSQL_determine"
port = "27018"
username = "olistDataNoSQL_determine"
password = "a58d7f6576007994f08b45fe5ba53f8f7da4e4a4"
...
def clean_dataframe(df, name):
    print("Cleaning " + name)
    return df.dropDuplicates().na.drop(how='all')
...
final_df.write.mode("overwrite").parquet(
    "abfss://olistdata@olistdatastoragebyme.dfs.core.windows.net/silver/"
)